...
# Get the IP address of a node from here https://bitcoin.stackexchange.com/a/17410/104912
# If you're using an adblocker DNS then this query might fail
# For that reason, I'm using the IP address directly
# You can try using the domain name since the IP might change
